  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    {
      ...
      submenu: [
        ...
        { label: 'Save As...', accelerator: 'Shift+CmdOrCtrl+S', click: () => sendCommand('save-as') },
        { type: 'separator' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Strikethrough', accelerator: 'CmdOrCtrl+Shift+X', click: () => sendCommand('strike') },
        ...
        { type: 'separator' },
        { label: 'Bullet List', accelerator: 'CmdOrCtrl+Shift+8', click: () => sendCommand('bullet-list') },
        { label: 'Ordered List', accelerator: 'CmdOrCtrl+Shift+7', click: () => sendCommand('ordered-list') },
        { label: 'Task List', accelerator: 'CmdOrCtrl+Shift+9', click: () => sendCommand('task-list') },
        { type: 'separator' },
        { label: 'Blockquote', accelerator: 'CmdOrCtrl+Shift+.', click: () => sendCommand('blockquote') },
        { label: 'Code Block', accelerator: 'CmdOrCtrl+Shift+K', click: () => sendCommand('code-block') },
